// app/(app)/models/test-model/TestModelSettings.tsx
"use client";
...
interface TestModelSettingsProps {
  prompt: string;
  setPrompt: (value: string) => void;
  imageSize: string;
  setImageSize: (value: string) => void;
  imageSizeOptions: Array<{ value: string; label: string; icon: string }>; // Pass options
...
export default function TestModelSettings({
    prompt, setPrompt,
